...
export default function PaymentMethods() {
  ...
  const incrementQuantity = (itemId) => {
    ...
    const updatedQuantity = updatedItems.find(
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6">
          <div className="items">
            <div
              className="all my-3 p-3 d-flex gap-2 align-items-center"
              style={{ background: "#F8FCFD" }}
            >
              <input type="checkbox" name="all" id="" />
              <h4>All Items(4)</h4>
            </div>
            <div className="my-3 p-3" style={{ background: "#F8FCFD" }}>
              You can add-on items and select which item you want to checkout
            </div>
            {cartItems.items.map((item) => (
              <div
                key={item._id}
                className="order p-5  mb-3 d-flex  gap-5"
                style={{ background: "#F8FCFD" }}
              >
                <div className="image d-flex gap-4  align-items-center">
                  ...
                  <div className="caption">
                    ...
                    >
                      ...
                      ></i>
                      <p style={{ color: "#666", fontFamily: "Poppins" }}>
                        Add to Wishlist
                      </p>
                    </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="d-flex   align-items-center justify-content-center">
                        <Button
                          icon="pi pi-minus"
                          className="border rounded p-button-danger p-button-outlined"
                          onClick={() => decrementQuantity(item._id)}
                        ></Button>
                        <input
                          type="text"
                          value={item.quantity}
                          className="d-flex align-items-center justify-content-center font-bold mx-2 text-center  border rounded"
                          style={{
                            width: "50px",
                            height: "50px",
                            display: "block",
                        ...
                        <Button
                          icon="pi pi-plus"
                          className="p-button-outlined border rounded p-button-success"
