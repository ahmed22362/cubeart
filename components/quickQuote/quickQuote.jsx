    ...
    const [responseMessage, setMessage] = useState(null);
        const sendEmail = async () => {
            ...
            try {
                ...
                if (isValid) {
                    emailjs
                        .sendForm('service_f9khdvu', 'template_degpul8', form.current, '3FqJG_Ro56DWbg4Wt')
                        .then((result) => {
    ...
    return (
        <div className={styles.ourFormStyle}>
            ...
            <form action="" ref={form} onSubmit={handleSubmit(sendEmail)}>
                ...
                <div className={"row" + styles.fromHalfSection}>
                    <div className="form-outline" style={{display: 'flex', flexDirection: "column"}}>
                        <input type="text" id="form3Example4" className={styles.item} placeholder="Subject" {...register('subject')} name="subject"/>
                    ...
                    <div className="form-outline mb-4" style={{display: 'flex', flexDirection: "column"}}>
                        <textarea className={styles.item + " textArea"} style={{resize: "none", height: "120px"}} id="form4Example5" {...register('message')} placeholder="Your Message" name='message'></textarea>
