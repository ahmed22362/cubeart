...
export default function CarsouleItemSlider({
  headerText,
  carsouelText,
  firstBtn,
  secBtn,
    ...
    <div className={`carousel-item ${active} ${styles.carsouelItem}`}>
      ...
      >
        ...
        <div className={styles.carosuelBtns}>
          <button className={btnColor} onClick={handleFirstButton}>
            {firstBtn}
          </button>
          <button className={styles.white} onClick={handleSecondButton}>
            {secBtn}
          </button>
        </div>
      </div>
      <Image
        src={`/Carsouel-images/${img}`}
        className={styles.carosuelImg}
        sizes="100vw"
        style={{
          width: "100%",
          height: "auto",
