    ...
    <StepContainer md="12">
      <div className="mt-4 d-flex justify-content-center align-items-center flex-column">
        <div className="circle d-flex justify-content-center align-items-center">
          <Image src="images/Done.png" className="w-75 " alt="" />
        </div>
          ...
          <div style={{ minHeight: "50vh" }}>
            ...
            <div className="payment  my-4">
              ...
              <div className="material d-flex gap-4 align-items-center ">
                <Image src="./images/card-pos.png" alt="" />
                <div className="caption mt-2">
        ...
        <div className="post_services mt-4">
          ...
          <div className="dropdown d-flex justify-content-center my-3">
            <div className="">
              <SelectButton
                value={Postvalue}
                onChange={(e) => setPostValue(e.value)}
                optionLabel="name"
                options={items}
              />
            </div>
    ...
    <StepContainer>
      <div style={{ width: "100%", padding: " 10px", height: "100%" }}>
        ...
        <div className="box mt-5">
          ...
          <div className="material d-flex gap-4 align-items-center ">
            <Image src="./images/Rectangle12.png" alt="" />
            <div className="caption mt-2">
          ...
          <div className=" material d-flex gap-4 align-items-center ">
            <Image src="./images/Rectangle13.png" alt="" />
            <div className="caption mt-2">
          ...
          <div className="density mt-5 w-100 ">
            ...
            <input
              type="text"
              placeholder="ex:10 %"
              className="px-3 py-2 density_value w-100"
            />
