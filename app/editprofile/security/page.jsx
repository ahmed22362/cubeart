  ...
  return (
    <div className="col-md-7">
      ...
      <div className="p-5 mb-5 bg-white rounded">
        ...
        <form>
          {/* ... (other input fields) */}
          <label className="ms-3 mt-4 d-block" htmlFor="currentPassword">
            Current Password
          </label>
          <Password
          ...
          <label className="ms-3 mt-4 d-block" htmlFor="newPassword">
            New password
          </label>
          <Password
            inputClassName="input-group form-control"
          ...
          <label className="ms-3 mt-4 d-block" htmlFor="confirmNewPassword">
